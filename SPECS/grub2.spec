...
Source90000:          ciq_sb_ca.der
Source90001:          ciq_sb_grub2.crt
...
%define old_sb_key	ciq_sb_grub2
...
%build
%if 0%{with_efi_arch}
%{expand:%do_primary_efi_build %%{grubefiarch} %%{grubefiname} %%{grubeficdname} %%{_target_platform} %%{efi_target_cflags} %%{efi_host_cflags} %{SOURCE90000} %{SOURCE90001} ciq_sb_grub2}
%endif
%if 0%{with_alt_efi_arch}
%{expand:%do_alt_efi_build %%{grubaltefiarch} %%{grubaltefiname} %%{grubalteficdname} %%{_alt_target_platform} %%{alt_efi_target_cflags} %%{alt_efi_host_cflags} %{SOURCE90000} %{SOURCE90001} ciq_sb_grub2}
%endif
%if 0%{with_legacy_arch}
...
%changelog
* Sun Feb 19 2023 Skip Grube <sgrube@ciq.co> - 2.02-142
- Porting Rocky 8 secureboot grub2 to CIQ build

* Mon Jan 09 2023 Release Engineering <releng@rockylinux.org> - 2.02-142.rocky.0.2
